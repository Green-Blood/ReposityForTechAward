...
namespace Game.Shared
{
    public class GameInitializer : IInitializable, IDisposable
    {
        ...
        private readonly IObjectRegistrar _characterProjectileRegistrar;
        ...
        public GameInitializer(
            ...
            [Inject(Id = RegistrarTypes.CharacterProjectile)] IObjectRegistrar characterProjectileRegistrar,
        ...
        )
        {
            ...
            _characterProjectileRegistrar = characterProjectileRegistrar;
        ...
        public async void Initialize()
        {
            ...
            await _characterProjectileRegistrar.Register();
