...
{
    public class EnemyRangedInstaller : Installer<EnemyStaticData, EnemyMeleeInstaller>
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<HealthBar>()
                .FromComponentInNewPrefab(_enemyStaticData.HealthBarPrefab)
                .UnderTransform(_enemyView.TransformView)
                .AsSingle()
                .NonLazy();
            ...
            Container.Bind<IHitChecker>().To<RangedHitChecker>().AsSingle().NonLazy();
