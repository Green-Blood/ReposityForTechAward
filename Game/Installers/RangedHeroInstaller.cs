...
{
    public class RangedHeroInstaller : Installer<HeroStaticData, RangedHeroInstaller>
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<HealthBar>()
                .FromComponentInNewPrefab(_heroStaticData.HealthBarPrefabPrefab)
                .UnderTransform(_characterView.TransformView)
                .AsSingle()
                .NonLazy();
            ...
            Container.Bind<IHitChecker>().To<RangedHitChecker>().AsSingle().WithArguments(_heroStaticData.AttackData).NonLazy();
